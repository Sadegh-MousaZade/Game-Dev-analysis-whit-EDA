...
1. What should we create? Identifying high-demand genres and platforms.
2. How do regional preferences influence sales? Understanding genre and platform preferences in NA, EU, and JP.
3. What strategies drive global success? Analyzing trends, market saturation, and release timing.


## Methodology
Data Cleaning
1. Removed games with release years after 2015 to focus on relevant trends.
...
3. Verified data integrity with statistical summaries and null checks.
...
1. Genre Focus: Prioritize Action, Sports, and Role-Playing genres for broad appeal, while exploring niche markets like Puzzle or Strategy.
2. Platform Strategy: Optimize games for leading platforms like Nintendo and PlayStation.
3. Regional Customization: Tailor game themes and mechanics to regional preferences (e.g., Role-Playing for Japan, Sports for NA/EU).
4. Release Timing: Target launch windows with lower market saturation to maximize visibility and sales.
...
## Repository Structure
  ...
  Doc.pdf: Presentation slides summarizing the project, key findings, and recommendations.
